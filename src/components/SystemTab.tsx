    ...
    <section id="system-tab" data-section="system-tab" className="py-24 bg-bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-bg-elevated/30 rounded-3xl p-8 lg:p-12 border border-accent-shadow/20 relative backdrop-blur-sm hover:bg-bg-elevated/40 transition-all duration-300">
              ...
              {!isUnlocked ? (
                <div className="text-center">
                  ...
                  <div className="max-w-md mx-auto">
                    <div className="flex gap-3 mb-4">
                      <div className="flex-1 relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 bg-bg-elevated/40 border rounded-xl text-white placeholder-text-tertiary focus:outline-none transition-colors backdrop-blur-sm ${
                            emailError 
                              ? 'border-red-500 focus:border-red-400' 
                              : 'border-accent-shadow/30 focus:border-accent-shadow'
                          }`}
                          required
                        />
                      </div>
                    ...
                    {emailError && (
                      <div className="text-red-400 text-sm mb-4 text-left">
                        {emailError}
                      </div>
                    )}
                    ...
                    <button
                      ...
                      disabled={!email || isLoading || !!emailError}
                ...
                <div className="text-center">
                  ...
                  <div className="bg-accent-mana/20 border border-accent-mana/30 rounded-2xl p-6 mb-6 backdrop-blur-sm">
